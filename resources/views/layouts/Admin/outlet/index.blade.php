                                    ...
                                    <div class="mb-3">
                                        <div class="row">
                                            <div class="col-12 text-sm-center form-inline">
                                                <div class="form-group mr-2">
                                                    <button type="button" id="demo-btn-addrow" class="btn btn-primary" data-toggle="modal" data-target="#con-close-modal"><i class="mdi mdi-plus-circle mr-2"></i> Add New Outlet</button>
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
                                        ...
                                        <table id="" class="table table-striped table-bordered dt-responsive nowrap" style="border-collapse: collapse; border-spacing: 0; width: 100%;">
                                            ...
                                            <tr>
                                                ...
                                                <td>{{$row->telepon}}</td>
                                                <td>
                                                    <a href="{{url('admin/outlet/edit',$row->id)}}" class="btn btn-sm btn-primary"><i class="mdi mdi-pencil"></i></a>
                                                    <a href="{{url('admin/outlet/delete',$row->id)}}" class="btn btn-sm btn-danger" onclick="return confirm('apa kamu serius?')"><i class=" fas fa-trash"></i></a></td>
                                                    </tr>
                                                    @endforeach
                                            </tbody>
                                        </table>
                                    ...
                                    <div id="con-close-modal" class="modal fade" tabindex="-1" role="dialog" aria-hidden="true" style="display: none;">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                              <form action="{{ route('admin.outlet.store')}}" method="POST" enctype="multipart/from-data">
                                                @csrf
